...
const styles = StyleSheet.create({
  ...
  sectionTitle: { fontSize: 12, fontFamily: fonts.semiBold, color: colors.text.tertiary, textTransform: 'uppercase', marginBottom: 14, marginLeft: 4, letterSpacing: 0.5 },
  card: { backgroundColor: colors.surface, borderRadius: 18, borderWidth: 1, borderColor: colors.border, overflow: 'hidden' },
  label: { fontSize: 15, fontFamily: fonts.medium, color: colors.text.primary, paddingHorizontal: 18, paddingTop: 18, marginBottom: 14 },
  hint: { fontSize: 12, fontFamily: fonts.regular, color: colors.text.tertiary, paddingHorizontal: 18, paddingBottom: 18, lineHeight: 19 },
  backendRow: { flexDirection: 'row', gap: 10, paddingHorizontal: 18, marginBottom: 10 },
  backendBtn: { flex: 1, height: 44, borderRadius: 12, borderWidth: 1, borderColor: colors.border, alignItems: 'center', justifyContent: 'center', backgroundColor: 'rgba(255,255,255,0.02)' },
  ...
  infoRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', padding: 18, borderBottomWidth: 1, borderBottomColor: colors.border },
  ...
  infoText: { marginTop: 28, fontSize: 13, fontFamily: fonts.regular, color: colors.text.tertiary, lineHeight: 20, textAlign: 'center', paddingHorizontal: 10 }
});
